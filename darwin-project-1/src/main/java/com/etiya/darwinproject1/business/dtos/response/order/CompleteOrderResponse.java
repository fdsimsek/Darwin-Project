...
public class CompleteOrderResponse {
    ...
    @Autowired
    public CompleteOrderResponse(UserInfoResponse userInfoResponse, List<ListOfferResponse> listOfferResponses, List<CustOrdCharValResponse> custOrdCharValResponses) {
